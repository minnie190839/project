...
public class ListViewSky extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_sky);
        mHelper = new DBList(this);
        mDb = mHelper.getReadableDatabase();

        loadDataFromDb();
//        ArrayList<PictureItem> currentPictureItem = checkType("SKY");

        adapterList = new AdapterList(this,R.layout.activity_sky, checkType("SKY"));
