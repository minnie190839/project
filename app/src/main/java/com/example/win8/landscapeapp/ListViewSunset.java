...
public class ListViewSunset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_sunset);

        mHelper = new DBList(this);
        mDb = mHelper.getReadableDatabase();

        loadDataFromDb();
//        ArrayList<PictureItem> currentPictureItem = checkType("SUNSET");
